...
initial = torch.tensor([0.001, 0.001, 0.001, 0, 0, 0])
target = torch.tensor([0.008, 0.008, 0.008])
...
for i_episode in itertools.count(1):
    ...
    while not done:
        if args.start_steps > total_numsteps:  #first hundred (if default) steps:
